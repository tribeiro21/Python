...
titulo = Label(marco,text="Ventana de Usuario",fg="black",font=("Arial,Verdana,sans-serif",24))
titulo.pack(side=TOP)
autor = Label(marco,text="Tony Ribeiro",fg="blue",font=("Arial,Verdana,sans-serif",16))
autor.pack(side=TOP)

foto = PhotoImage(file="imagene.png",width=100,height=100)
textofoto = Label(marco,image=foto)
textofoto.pack(side=TOP)

titulo = Label(marco,text="Introduce tu nombre",fg="black",font=("Arial,Verdana,sans-serif",14))
titulo.pack(side=TOP)
camponombre = Entry(marco)
camponombre.pack(side=TOP)

titulo = Label(marco,text="Introduce tu telefono",fg="black",font=("Arial,Verdana,sans-serif",14))
titulo.pack(side=TOP)
campotelefono = Entry(marco)
campotelefono.pack(side=TOP)

titulo = Label(marco,text="Introduce tu email",fg="black",font=("Arial,Verdana,sans-serif",14))
titulo.pack(side=TOP)
